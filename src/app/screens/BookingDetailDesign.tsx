      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          <div className="flex-1 overflow-y-auto px-5 pb-5 -mt-8">
            ...
            >
              ...
              <div className="flex gap-2">
                <div className="flex-1 bg-[#25D366] text-white rounded-[10px] py-2 text-[9px] font-bold text-center">
                  📲 WhatsApp
                </div>
                <div className="flex-1 bg-[#0088CC] text-white rounded-[10px] py-2 text-[9px] font-bold text-center">
                  📞 Call
                </div>
              </div>
            </div>
          ...
          <div className="px-4 pb-4 flex flex-col gap-2">
            <div className="w-full bg-[#25D366] text-white rounded-[14px] py-3 text-[11px] font-bold text-center">
              📲 Share Booking Details · शेयर करें
            </div>
            <div className="flex gap-2">
              <div
                className="flex-1 text-white rounded-[14px] py-3 text-xs font-bold text-center"
