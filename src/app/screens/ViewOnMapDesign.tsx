        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: 'white' }}>
          ...
          <div className="bg-white px-4 pt-4 pb-3" style={{ boxShadow: '0 2px 10px rgba(0,0,0,0.06)' }}>
            ...
            <div className="flex gap-2">
              ...
              <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[12px]" style={{ background: 'var(--saffron)', color: 'white' }}>
                🎤
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 relative" style={{ background: '#F0F4F8' }}>
            ...
            <div className="absolute right-4 top-4 flex flex-col gap-2">
              <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center text-[12px] shadow-lg">
                +
              </div>
              <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center text-[12px] shadow-lg">
                −
            ...
            <div className="absolute left-4 top-4 bg-white rounded-lg px-2 py-1 shadow-lg">
              <div className="flex gap-2">
                <div className="text-[9px] font-bold" style={{ color: 'var(--saffron)' }}>Map</div>
                <div className="text-[9px]" style={{ color: 'var(--text-soft)' }}>Satellite</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-20 left-4 right-4">
            ...
            >
              ...
              <div className="flex gap-2">
                <div className="flex-1 bg-[#25D366] text-white rounded-[12px] py-2 text-[10px] font-bold flex items-center justify-center gap-1">
                  🗺️ Get Directions · दिशा प्राप्त करें
                </div>
                <div className="flex-1 rounded-[12px] py-2 text-[10px] font-bold text-center" style={{ background: 'var(--cream)', color: 'var(--text-dark)' }}>
          ...
          <div className="absolute bottom-4 left-4 right-4 flex gap-2">
            <div className="flex-1 bg-white rounded-[14px] py-3 text-[11px] font-bold text-center shadow-lg">
