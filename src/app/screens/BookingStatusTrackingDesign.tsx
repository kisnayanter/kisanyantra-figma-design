        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: 'var(--cream)' }}>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div 
                className="w-8 h-8 rounded-[10px] flex items-center justify-center text-white text-base animate-pulse"
                style={{ background: 'rgba(255,255,255,0.2)' }}
              >
                🔴
              </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            >
              ...
              <div className="flex gap-2">
                <div className="w-8 h-8 rounded-lg bg-[#25D366] flex items-center justify-center text-white text-[12px]">
                  📞
                </div>
                <div className="w-8 h-8 rounded-lg bg-[#0088CC] flex items-center justify-center text-white text-[12px]">
                  💬
                </div>
              </div>
            </div>
