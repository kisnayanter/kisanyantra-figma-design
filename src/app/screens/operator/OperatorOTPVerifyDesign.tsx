...
export function OperatorOTPVerifyDesign() {
              ...
              <div className="mb-5">
                <div className="text-center mb-3">
                  ...
                  <div className="flex items-center justify-center gap-2 mt-2">
                    ...
                    <button className="text-[11px] font-medium" style={{ color: 'var(--operator-blue)', ...interFont }}>
                      Edit
                    </button>
                  </div>
                </div>
                ...
                <div className="flex justify-center gap-2 mb-3">
                  {[1, 2, 3, 4, 5, 6].map((digit) => (
                    <div
                      ...
                      style={{
                        borderColor: digit <= 3 ? 'var(--operator-blue)' : '#E6E1D8',
                        background: digit <= 3 ? 'rgba(47,128,255,0.05)' : '#FFF'
                      }}
                    >
