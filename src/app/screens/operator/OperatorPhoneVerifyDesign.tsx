...
export function OperatorPhoneVerifyDesign() {
  const { selectText } = useLanguage();
  const t = (options: Parameters<typeof selectText>[0]) => selectText(options);

  const strings = {
    welcomeBack: t({
      english: 'Operator Registration',
      hindi: 'ऑपरेटर पंजीकरण',
      tamil: 'செயல்படுத்தி பதிவு',
      marathi: 'ऑपरेटर नोंदणी'
    }),
    tagline: t({
      english: 'Enter your phone number to continue',
      hindi: 'जारी रखने के लिए अपना फोन नंबर दर्ज करें',
      tamil: 'தொடர உங்கள் தொலைபேசி எண்ணை உள்ளிடவும்',
      marathi: 'सुरू ठेवण्यासाठी तुमचा फोन नंबर टाका'
    }),
    phoneLabel: t({
