        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          <div className="flex-1 overflow-y-auto px-5 pb-5 -mt-4 space-y-4">
            ...
            >
              ...
              <button className="ky-tap-back flex-shrink-0 text-white text-lg opacity-70 hover:opacity-100">
                ✕
              </button>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <button
                  className="ky-tap-cta-secondary text-[11px] font-bold px-3 py-1.5 rounded-lg bg-white hover:opacity-90 transition-opacity"
