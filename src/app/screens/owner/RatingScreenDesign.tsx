      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: 'var(--cream)' }}>
          ...
          <div className="flex-1 overflow-y-auto px-[18px] py-5">
            ...
            <div className="flex justify-center gap-3 mb-6">
              {[1, 2, 3, 4, 5].map((star) => (
                <div
                  key={star}
                  className="ky-tap-star text-[36px]"
                  style={{
            ...
            <div className="flex gap-2 flex-wrap mb-5">
              {[
                ...
                <div
                  key={tag.id}
                  className="ky-tap-chip rounded-[20px] px-3 py-1 text-[11px] font-semibold"
                  style={{
          ...
          <div className="px-[18px] pb-5">
            <div
              className="ky-tap-cta-primary w-full rounded-[14px] py-[14px] text-[15px] font-bold text-white text-center"
              style={{
