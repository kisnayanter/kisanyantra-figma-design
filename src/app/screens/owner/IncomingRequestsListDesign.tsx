        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div
                className="ky-tap-icon w-8 h-8 rounded-[10px] flex items-center justify-center text-white text-base relative"
                style={{ background: 'rgba(255,255,255,0.2)' }}
              >
                🔔
                <div 
          ...
          <div className="flex-1 overflow-y-auto px-5 pb-5 -mt-6">
            ...
            <div className="flex bg-white rounded-[20px] mb-4 p-1" style={{ boxShadow: 'var(--card-shadow)' }}>
              <button
                className="ky-tap-tab flex-1 py-2 text-center text-[11px] font-semibold rounded-[14px]"
            ...
            {pendingRequests.map((request, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    className="ky-tap-action-confirm rounded-[10px] px-4 py-2 text-[11px] font-bold text-white"
                ...
                <button
                  className="ky-tap-link w-full mt-3 pt-3 text-[11px] font-semibold text-center"
                  style={{ 
          ...
          {/* Bottom Nav */}
          <OwnerBottomNav activeTab="bookings" />
