      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative" style={{ background: '#F9F6F0' }}>
          ...
          <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
            <div className="w-[220px] h-[220px] rounded-full" style={{ background: 'rgba(31,122,76,0.12)', filter: 'blur(40px)', position: 'absolute', top: '-30px', right: '-40px' }} />
          ...
          <div className="flex flex-col h-full px-5 pb-5 relative z-10">
            ...
            <div
              ...
              style={{ background: 'var(--gradient-green)', boxShadow: 'var(--card-shadow-green)' }}
            >
