        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          <div className="flex-1 overflow-y-auto px-5 pb-5 -mt-4">
            ...
            <div className="bg-white rounded-[20px] p-4 mb-[14px]" style={{ boxShadow: 'var(--card-shadow)' }}>
              ...
              <button
                className="ky-tap-cta-secondary w-full rounded-xl py-2 text-[12px] font-semibold flex items-center justify-center gap-2"
            ...
            <div className="bg-white rounded-[18px] p-4" style={{ boxShadow: 'var(--card-shadow)' }}>
              ...
              >
                <button className="ky-tap-icon text-2xl">▶️</button>
          ...
          <div className="px-5 pb-5 pt-2 flex gap-3">
            <button
              className="ky-tap-action-destructive flex-1 rounded-2xl py-[15px] font-bold text-[15px]"
              style={{
                background: 'white',
                color: 'var(--text-dark)',
            ...
            <button
              className="ky-tap-action-confirm flex-1 rounded-2xl py-[15px] font-bold text-[15px] text-white"
              style={{
