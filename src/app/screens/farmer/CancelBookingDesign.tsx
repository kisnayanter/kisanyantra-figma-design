      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: 'var(--cream)' }}>
            ...
            >
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div
                    key={reason}
                    className="ky-tap-radio flex items-center gap-3 p-2 rounded-lg"
                    style={{ 
          ...
          <div className="px-4 pb-4 flex flex-col gap-2">
            <div
              className="ky-tap-action-destructive w-full text-white rounded-[14px] py-3 text-sm font-bold text-center"
              style={{ background: 'linear-gradient(135deg, #CC3333, #FF6666)', boxShadow: '0 4px 16px rgba(204,51,51,0.35)' }}
            >
              ✕ Confirm Cancellation
            </div>
            <div
              className="ky-tap-cta-secondary w-full rounded-[14px] py-3 text-sm font-bold text-center"
