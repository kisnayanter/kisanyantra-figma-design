          ...
          <div className="px-4 pt-4 pb-2" style={{ background: '#F8F5F0' }}>
            <div className="flex gap-2 overflow-x-auto pb-1">
              {quickFilters.map((filter) => (
                <button
                  key={filter.label}
                  className="ky-tap-chip px-3 h-8 rounded-full text-[12px] font-medium whitespace-nowrap"
                  style={{
            ...
            {hasResults ? (
              <div className="space-y-4">
                {results.map((result) => (
                  <div
                    key={result.name}
                    className="ky-tap-card bg-white rounded-[16px] p-4 flex gap-3"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-2 mt-3">
                        <button
                          className="ky-tap-share flex-1 h-10 rounded-[10px] text-[13px] font-semibold"
                          style={{ background: '#fff8f2', color: 'var(--saffron)', border: '1px solid rgba(255,139,56,0.4)' }}
                        >
                          Share
                        </button>
                        <button
                          className="ky-tap-cta-primary flex-1 h-10 rounded-[10px] text-[13px] font-semibold"
              ...
              <div className="rounded-[20px] p-6 bg-white text-center" style={{ boxShadow: 'var(--card-shadow)' }}>
                ...
                <div className="mt-4 pt-4" style={{ borderTop: '1px solid #F0EDE7' }}>
                  <div className="text-[12px] font-semibold mb-2" style={{ color: 'var(--text-mid)' }}>
                    Can't find what you need?
                  </div>
                  <button
                    className="ky-tap-cta-primary w-full rounded-[14px] py-3 text-[13px] font-bold text-white flex items-center justify-center gap-2"
                    style={{
                      background: 'linear-gradient(135deg, var(--saffron), #FF8C38)',
                      boxShadow: '0 4px 16px rgba(255,107,0,0.35)'
                    }}
                  >
                    <span>{'\u{1F4E2}'}</span> Post a Request — We'll find it for you
                  </button>
                </div>
              </div>
            )}
