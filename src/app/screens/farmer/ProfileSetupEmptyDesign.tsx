      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
            ...
            <div className="bg-white rounded-[20px] p-4 mb-[14px]" style={{ boxShadow: 'var(--card-shadow)' }}>
              ...
              <div className="flex gap-2 justify-center">
                {['👨‍🌾', '👩‍🌾', '🧑‍🌾', '👴', '👵'].map((emoji) => (
                  <div
                    key={emoji}
                    className="ky-tap-avatar w-14 h-14 rounded-2xl flex items-center justify-center text-[28px] cursor-pointer hover:opacity-80 transition-opacity"
                    style={{
            ...
            <div className="bg-white rounded-[18px] p-4 mt-[10px]" style={{ boxShadow: 'var(--card-shadow)' }}>
              ...
              <div className="flex items-center gap-2">
                {['1-5', '5-10', '10+'].map((size) => (
                  <div
                    key={size}
                    className="ky-tap-chip flex-1 rounded-[12px] py-2 text-center text-[13px] font-semibold cursor-pointer hover:opacity-80 transition-opacity"
                    style={{
                      background: 'var(--cream)',
                      border: '2px solid #E8E3DA',
                      color: 'var(--text-mid)'
            ...
            <div className="bg-white rounded-[18px] p-4 mt-[10px]" style={{ boxShadow: 'var(--card-shadow)' }}>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <div
                    key={eq.label}
                    className="ky-tap-chip flex items-center gap-1.5 px-3 py-2 rounded-xl text-[12px] font-semibold cursor-pointer hover:opacity-80 transition-opacity"
                    style={{
                      background: 'var(--cream)',
                      border: '2px solid #E8E3DA',
                      color: 'var(--text-dark)'
          ...
          <div className="px-5 pb-5 pt-2">
            <button
              className="ky-tap-cta-primary w-full rounded-2xl py-[15px] font-bold text-[15px] text-white opacity-50"
              style={{
