        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: 'var(--cream)' }}>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div
                className="ky-tap-card bg-white rounded-[18px] p-4 text-center"
                style={{
            ...
            >
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div
                    key={i}
                    className="ky-tap-card rounded-lg p-3 text-[10px] cursor-pointer"
                    style={{ 
            ...
            >
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                <div className="flex gap-2">
                  <div className="ky-tap-icon w-6 h-6 rounded-full flex items-center justify-center text-[10px]" style={{ background: 'var(--saffron-pale)', color: 'var(--saffron)' }}>
                    📎
                  </div>
                  <div className="ky-tap-icon w-6 h-6 rounded-full flex items-center justify-center text-[10px]" style={{ background: 'var(--green-pale)', color: 'var(--green)' }}>
                    🎤
                  </div>
                </div>
              </div>
          ...
          <div className="px-4 pb-4 flex flex-col gap-2">
            <div className="ky-tap-cta-primary w-full bg-[#25D366] text-white rounded-[14px] py-3 text-[12px] font-bold flex items-center justify-center gap-1.5">
              📲 Send WhatsApp Message · संदेश भेजें
            </div>
            <div className="flex gap-2">
              <div
                className="ky-tap-cta-primary flex-1 bg-[#0088CC] text-white rounded-[14px] py-3 text-xs font-bold text-center"
              >
                📞 Call Now · कॉल करें
              </div>
              <div
