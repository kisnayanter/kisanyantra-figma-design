...
export function BookingOTPDesign() {
  ...
  const strings = {
    ...
    verify: t({
      english: '✓ Verify & Book',
      hindi: '✓ सत्यापित करें और बुक करें',
      tamil: '✓ சரிபார்த்து புக் செய்யவும்',
      marathi: '✓ पडताळा आणि बुक करा'
    }),
    autoRead: t({
    ...
    bookingReady: t({
      english: 'Your booking is almost done!',
      hindi: 'आपकी बुकिंग लगभग पूरी है!',
      tamil: 'உங்கள் புக்கிங் கிட்டத்தட்ட முடிந்தது!',
      marathi: 'तुमची बुकिंग जवळजवळ पूर्ण झाली!'
    })
  };
    ...
    <div className="relative mx-auto" style={{ width: '320px', height: '640px' }}>
      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          {/* Bottom CTA - GREEN for final booking action */}
