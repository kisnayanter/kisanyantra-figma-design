export function RoleSelectFarmerDesign() {
  return (
        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          <div className="flex-1 px-5 pb-5 -mt-4 overflow-y-auto">
            <div className="flex flex-col gap-[14px]">
              ...
              {/* Unselected */}
              <div
                className="ky-tap-radio bg-white rounded-[20px] p-5 flex items-center gap-4 opacity-40"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-[11px] leading-relaxed" style={{ color: 'var(--text-dark)' }}>
                    <strong>As a farmer,</strong> you can browse nearby equipment, book instantly with voice commands, and track your bookings.
                  </div>
                </div>
              </div>
            </div>
