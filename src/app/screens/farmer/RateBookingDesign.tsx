        ...
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          <div className="flex-1 overflow-y-auto px-5 pb-5 -mt-8">
            ...
            >
              ...
              <div className="ky-tap-star text-[40px] mb-3">⭐⭐⭐⭐⭐</div>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.label} className="ky-tap-star flex justify-between items-center">
            ...
            >
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                <div className="flex gap-2">
                  <div className="ky-tap-icon w-5 h-5 rounded-full flex items-center justify-center text-[9px]" style={{ background: 'var(--saffron-pale)', color: 'var(--saffron)' }}>
                    📷
                  </div>
                  <div className="ky-tap-icon w-5 h-5 rounded-full flex items-center justify-center text-[9px]" style={{ background: 'var(--green-pale)', color: 'var(--green)' }}>
                    📎
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <div
                    key={tag}
                    className="ky-tap-chip rounded-lg px-2 py-1 text-[8px] font-bold cursor-pointer"
                    style={{ 
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2">
                <div 
                  className="ky-tap-upload aspect-square rounded-lg flex items-center justify-center text-[18px]"
          ...
          <div className="px-4 pb-4 flex flex-col gap-2">
            <div className="ky-tap-cta-primary w-full bg-[#25D366] text-white rounded-[14px] py-3 text-[11px] font-bold flex items-center justify-center gap-1.5">
              ⭐ Submit Review · समीक्षा जमा करें
            </div>
            <div
              className="ky-tap-cta-secondary w-full rounded-[14px] py-3 text-xs font-bold text-center"
