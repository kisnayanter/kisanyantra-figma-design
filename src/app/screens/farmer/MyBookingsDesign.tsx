      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          <div className="flex-1 overflow-y-auto px-5 pb-5 -mt-8">
            {/* Segmented Control: Bookings | Requests */}
            <div className="flex bg-white rounded-[20px] mb-3 p-1" style={{ boxShadow: 'var(--card-shadow)' }}>
              <div
                className="ky-tap-tab flex-1 py-2.5 text-center text-xs font-bold rounded-[16px] text-white"
                style={{ background: 'var(--saffron)' }}
              >
                Bookings
              </div>
              <div className="ky-tap-tab flex-1 py-2.5 text-center text-xs font-semibold" style={{ color: 'var(--text-soft)' }}>
                Requests
              </div>
            </div>
            ...
            <div className="flex bg-white rounded-[20px] mb-4" style={{ boxShadow: 'var(--card-shadow)' }}>
              <div
                ...
                style={{ color: 'var(--saffron)', background: 'var(--saffron-pale)' }}
              >
                Active (2)
              </div>
            ...
            {activeBookings.map((booking) => (
              <div
                key={booking.id}
                className="ky-tap-card bg-white rounded-[20px] p-4 mb-4"
              ...
              >
                ...
                >
                  <div
                    className="ky-tap-action-confirm flex-1 text-center rounded-lg py-1.5 text-[9px] font-bold"
                    style={{ background: 'var(--green-pale)', color: 'var(--green)' }}
                  >
                    ✅ पूर्ण करें · Complete
                  </div>
                  <div
                    className="ky-tap-action-destructive flex-1 text-center rounded-lg py-1.5 text-[9px] font-bold"
            ...
            {pastBookings.map((booking) => (
              <div
                key={booking.id}
                className="ky-tap-card bg-white rounded-[20px] p-4 mb-3 opacity-75"
                style={{ boxShadow: 'var(--card-shadow)' }}
              >
