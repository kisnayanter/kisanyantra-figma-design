    ...
    <div className="relative mx-auto" style={{ width: '320px', height: '640px' }}>
      ...
      >
        ...
        >
          ...
          {/* Close Button */}
          <div className="ky-tap-back absolute top-6 right-[18px] w-8 h-8 rounded-full flex items-center justify-center text-white text-base z-20" style={{ background: 'rgba(255,255,255,0.1)' }}>
            ✕
          </div>
          ...
          {/* Main Mic Button */}
          <div
            className="ky-tap-mic w-20 h-20 rounded-full flex items-center justify-center text-[36px] mt-7 relative z-10"
            style={{
          ...
          {/* Mode Pill */}
          <div
            className="ky-tap-chip absolute bottom-[30px] px-4 py-1.5 rounded-[20px] text-[11px] font-semibold tracking-wide z-10"
            style={{
              background: 'rgba(255,255,255,0.1)',
              border: '1px solid rgba(255,255,255,0.2)',
