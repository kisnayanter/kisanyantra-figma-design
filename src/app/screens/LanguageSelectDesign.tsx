          ...
          <div className="h-full flex flex-col items-center justify-center px-5 pb-10 relative overflow-hidden">
            ...
            <div className="w-full relative z-10">
              ...
              <div className="flex flex-col gap-[10px] mb-5">
                <div
                  className="w-full rounded-2xl p-[14px] flex items-center gap-[14px] bg-white"
                ...
                {['Tamil · தமிழ்', 'Marathi · मराठी'].map((lang) => (
                  <div
                    key={lang}
                    className="w-full rounded-2xl p-[14px] flex items-center gap-[14px]"
              ...
              <button
                className="w-full bg-white rounded-2xl p-[14px] font-bold text-[15px]"
