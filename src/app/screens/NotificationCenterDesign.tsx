      ...
      >
        <div className="w-full h-full rounded-[28px] overflow-hidden relative flex flex-col" style={{ background: '#F8F5F0' }}>
          ...
          <div className="flex-1 overflow-y-auto px-5 pb-5 -mt-4">
            ...
            <div
              className="bg-white rounded-[18px] p-4 mb-3 relative"
              style={{ 
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    <button
                      className="flex-1 py-2 rounded-[10px] text-[12px] font-bold text-white"
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] font-semibold" style={{ color: 'var(--green)' }}>
